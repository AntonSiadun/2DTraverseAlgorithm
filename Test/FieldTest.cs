...
namespace Test
{
    ...
    public class FieldTest
    {
        ...
        public void Reading_PositionIsOutOfRange_ThrowsException()
        {
            ...
            Assert.Throws<IndexOutOfRangeException>(() => result = field[rowInPosition, colInPosition]);
        }
        ...
        public void Saving_PositionIsOutOfRange_ThrowsException()
        {
            ...
            Assert.Throws<IndexOutOfRangeException>( () => field[rowInPosition,colInPosition] = 0);
        }
        ...
        public void Saving_SetElement_IsEqualToFirst()
        {
            ...
            field[rowInPosition, colInPosition] = value;
            var array = field.GetArray();
        ...
        public void Array_GetCopyWithItem_ItemSavedAfterCoping()
        {
            ...
            field[rowPosition, colPosition] = value;
            var array = field.GetArray();
